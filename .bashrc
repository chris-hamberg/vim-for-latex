...
alias webull='/usr/local/WebullDesktop/WebullDesktop'
alias robinhood='chromium --app="https://robinhood.com"'
alias youtube='chromium --app="https://youtube.com"'
alias rec='python .sys/rec.py'

alias vim='vim --vimserver VIMSERVER'
